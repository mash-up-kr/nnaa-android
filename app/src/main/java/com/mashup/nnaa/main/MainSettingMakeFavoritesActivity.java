...
public class MainSettingMakeFavoritesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_setting_make_favorites);
        ...
        if (Content_Edit.getText().toString().isEmpty() && Content_Edit.getText().toString().length() == 0) {
            Toast.makeText(MainSettingMakeFavoritesActivity.this, "질문 내용을 입력해주세요!", Toast.LENGTH_SHORT).show();
        ...
        CustomDone.setOnClickListener(view -> {
            ...
            Toast.makeText(MainSettingMakeFavoritesActivity.this, "질문 추가 완료!", Toast.LENGTH_SHORT).show();
            finish();
        });
    }
}
